        ...
        <section className="bg-secondary relative">
            ...
            <div
                ...
                <div className="md:ml-8 flex flex-col md:items-start items-center">
                    ...
                    <button className="overflow-hidden relative w-48 p-2 h-12 bg-primary mt-6 text-white border-none rounded-md text-xl font-primary capitalize font-bold cursor-pointer relative z-10 group hover:scale-105  transition-transform">
                        View my projects
                ...
                <svg
                    ...
                    <image
                        ...
                        clipPath="url(#cp)"
                        href="https://i.pinimg.com/736x/d8/b5/9d/d8b59d872071c6ca11c4f6bc515e52ed.jpg"
                    />
                </svg>
            </div>
        </section>
