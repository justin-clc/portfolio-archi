    ...
    <>
      ...
      <section className="bg-bgDark px-10 py-8">
        ...
        >
          ...
          <div class="absolute -right-12 top-4 z-10 h-24 w-24 rounded-full bg-sky-700 duration-500 group-hover:right-2  group-hover:top-1 group-hover:scale-150"></div>
          <div class="absolute -top-4 right-20 z-10 h-16 w-16 rounded-full bg-sky-600 duration-500 group-hover:right-2  group-hover:top-1 group-hover:scale-150"></div>
