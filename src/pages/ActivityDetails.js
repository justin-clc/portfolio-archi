		...
		<main className="relative -mt-16 w-full bg-bgMedium">
			...
			<section className="m-auto max-w-5xl pt-16">
				<div className="mx-auto max-w-screen-xl px-4 pt-24 text-center">
					<h1 className="mb-4 break-words font-primary text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl">
						{act.fields?.title}
					</h1>
					<span className="-mb-2 font-secondary text-2xl font-semibold text-accent">
						{act.fields?.subject}
					</span>
					<p className="mb-8 font-secondary text-lg font-normal text-gray-300 sm:px-16 lg:px-48 lg:text-xl">
						{act.fields?.shortDesc}
					</p>
					{act.fields?.asset.fields.file.url ? (
						<button
							className="group relative z-10 mb-8 h-12 w-36 cursor-pointer overflow-hidden rounded-md border-none bg-black p-2 text-xl font-bold text-white"
				...
				<section
					...
					className="mt-16 max-w-5xl px-4 py-8 font-primary text-white"
				>
