		...
		<div className="bg-bgDark">
			<footer className="mx-auto max-w-screen-2xl">
				...
				<div className="flex items-center justify-center py-6">
					...
					<span className="text-l font-primary capitalize leading-relaxed text-white">
				...
				<div className="rounded bg-bgMedium md:flex md:items-center md:justify-around">
					<div className="max-w-2xl flex-col p-4 md:px-6 md:py-8">
						<h4 className="flex items-center font-primary text-2xl text-secondary">
							<svg
								className="h-8 w-8"
								fill="currentColor"
								viewBox="0 0 24 24"
				...
				<div className="flex h-12 items-center justify-between bg-bgDark px-4 py-6">
					<span className="block px-3 font-primary text-sm text-secondary">
						&copy; Copyright 2024
					</span>

					<button
						type="button"
						className="flex items-center rounded pl-3 pr-2 font-primary text-sm font-bold text-secondary transition-colors hover:bg-secondary hover:text-bgDark"
						onClick={scrollToTop}
					>
						Back to top&nbsp;
						<svg
