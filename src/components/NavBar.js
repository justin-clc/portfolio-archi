	...
	window.addEventListener("resize", () => {
		try {
			...
			if (
				...
				!navMenu.classList.contains("scale-y-0")
			) {
	...
	return (
		<>
			<div className="sticky top-2 z-50 px-2">
				...
				<nav
					id="main-nav"
					className="mx-auto flex h-16 max-w-screen-2xl justify-between rounded bg-bgDark px-6 py-2 font-primary text-white"
				>
					{/* Nav Left */}
					<div className="flex items-center">
						...
						<h1 className="ml-6 hidden text-xl font-bold leading-tight xs:block sm:text-3xl">
							{isLoading ? (
					...
					<div className="text-l hidden items-center font-bold uppercase lg:flex">
						...
						>
							...
							<span className="absolute -left-2 -top-8 h-32 w-40 origin-right rotate-12 scale-x-0 transform bg-blue-500 transition-transform duration-700 group-hover:scale-x-100 group-hover:duration-700"></span>
				...
				<div className="relative max-w-screen-2xl">
					...
					>
						<ul className="pt-1 text-center font-primary font-bold uppercase text-white">
							<li>
								<NavMenuLink href="/portfolio-archi/">
									Home
								</NavMenuLink>
							</li>
							<li>
